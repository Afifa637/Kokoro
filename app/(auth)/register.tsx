// app/(auth)/register.tsx (or wherever your register page lives)
  ...
  return (
    <ImageBackground source={bg} style={styles.background} resizeMode="cover">
      ...
      <Animated.View entering={FadeInDown.delay(200).springify()} style={styles.container}>
        ...
        <Spacer height={20} />
        <TextInput placeholder="Email" placeholderTextColor="#ccc" keyboardType="email-address" style={styles.input} />
        <Spacer height={20} />
        <TextInput placeholder="Password" placeholderTextColor="#ccc" secureTextEntry style={styles.input} />
        <Spacer height={20} />
        <TextInput placeholder="Confirm Password" placeholderTextColor="#ccc" secureTextEntry style={styles.input} />
